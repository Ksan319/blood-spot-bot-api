...
public class SiteSelectSabCommand implements BotCommand {
    ...
    public void process(Long chatId, Update update) throws TelegramApiException {
        userService.setUserSite(chatId, UserSite.DONOR_MOS_SAB);
        if (userService.hasCredentials(chatId)) {
            ...
            menuDispatcher.sendMenu("auth", chatId, update, UserSite.DONOR_MOS_SAB.getBaseUrl());
        }
    }
}
