...
C -> A: /site_zar
A -> DB: Установить UserSite.DONOR_MOS_ZAR для пользователя
...
1. **Получение команды** — пользователь выбирает "Царицыно" в меню выбора сайта
2. **Установка сайта** — в БД для пользователя устанавливается `UserSite.DONOR_MOS_ZAR`
...
Выбранный сайт: **donor-mos-zar.online** (Царицыно)
