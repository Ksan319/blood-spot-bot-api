...
C -> A: /site_donor
A -> DB: Установить UserSite.DONOR_MOS для пользователя
...
1. **Получение команды** — пользователь выбирает "Поликарпова" в меню выбора сайта
2. **Установка сайта** — в БД для пользователя устанавливается `UserSite.DONOR_MOS`
...
Выбранный сайт: **donor-mos.online** (Поликарпова)
